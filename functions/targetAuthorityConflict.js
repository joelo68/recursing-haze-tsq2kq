...
const TARGET_AUTHORITY_CONFLICT_STATUS = "AUTHORITY_CONFLICT";
...
const buildTargetAuthoritySemanticSnapshot = (row = {}) => ({
...
const buildTargetAuthoritySemanticSignature = (row = {}) => (
...
const buildTargetAuthorityConflictRow = (current = {}, incoming = {}, options = {}) => {
...
const resolveTargetAuthorityConflict = (current = null, incoming = null, options = {}) => {
...
module.exports = {
  ...
  buildTargetAuthoritySemanticSnapshot,
  buildTargetAuthoritySemanticSignature,
  buildTargetAuthorityConflictRow,
