...
const SUMMARY_SEMANTIC_VERSION = "summary-semantics-v1";
const STORE_HEALTH_INPUT_VERSION = "store-health-input-v1";

const SUMMARY_KPI_STATUS = Object.freeze({
...
const buildFormalReportMetrics = (brandId, row = {}) => {
...
const aggregateFormalMetrics = (brandId, rows = []) => {
  const normalizedBrandId = normalizeKpiBrandId(brandId);
...
const extractTargetCoverageMetadata = (data = {}) => {
...
const buildSummaryTargetAuthoritySnapshot = ({
  targetMap = {},
  eligibleStoreKeys = [],
...
const buildScopeFormalAchievement = ({
  actualValue,
  actualStatus,
  targetValue,
  coverageComplete,
...
const buildStoreFormalKpiMetadata = (metrics = {}, target = {}) => {
...
const buildFormalStoreRanking = (storeMap = {}, targetMap = {}, options = {}) => {
  const byStore = {};
...
const buildSummaryStoreSemanticSignature = (summary = {}) => JSON.stringify(
...
const buildFormalRankingSignature = (summary = {}) => JSON.stringify(
