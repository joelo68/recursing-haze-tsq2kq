...
export const THERAPIST_KPI_SEMANTIC_VERSION = "therapist-kpi-v1";
...
export const isFiniteTherapistMetric = (value) => (
  typeof value === "number" && Number.isFinite(value)
);

export const ratioOfTotalsOrNull = (numerator, denominator, multiplier = 1) => {
...
export const buildTherapistSampleMetrics = (row = {}) => {
...
export const applyTherapistRankingSemantics = (rows = []) => {
...
export const buildTherapistAggregateMetrics = (rows = []) => {
  const source = Array.isArray(rows) ? rows : [];
...
export const buildTherapistSummarySignature = (summary = {}) => {
