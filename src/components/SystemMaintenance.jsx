...
export default function SystemMaintenance() {
  ...
  const handleLoadGlobalReadStats = async (options = {}) => {
    ...
    try {
      ...
      const rangeUnsupportedText = `此時段目前沒有小時級追蹤資料。舊版全域上報只記錄整個工作階段累積值，無法還原「${selectedRangeText}」的精準來源；新版上線後下一輪全域上報即可分析。`;
