...
const SettingsView = () => {
  ...
  const filteredTherapists = useMemo(() => { return therapists.filter(t => (t.name || "").includes(searchTerm) || (t.store || "").includes(searchTerm) || (t.status === 'resigned' && searchTerm === '離職')); }, [therapists, searchTerm]);
