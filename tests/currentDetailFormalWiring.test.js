...
test("Batch 7 extends the one view-scoped Store Lifecycle master listener to Annual without polling/per-store query", () => {
  const app = read("src/App.jsx");
  assert.match(app, /OPERATIONAL_FORMAL_LIFECYCLE_VIEWS = new Set\(\["dashboard", "regional", "ranking", "daily", "audit", "store-analysis", "annual"\]\)/);
